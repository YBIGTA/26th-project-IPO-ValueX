from crawling.article_crawling.base_crawler import BaseCrawler
...
class NaverStockCrawler(BaseCrawler):
    def __init__(self, output_dir:str, driver_path:str=None):
        ...
        self.output_file = os.path.join(self.output_dir, 'Naver_Stock_2023.csv')
        ...
        for (title, press, link) in tqdm(article_list, desc='Scraping Details'):
            try:
                ...
                try:
                    ...
                    # self.logger.info("본문을 받아왔습니다.")
                except:
                    body = ""
                    self.logger.error("본문에 내용이 없습니다.")
