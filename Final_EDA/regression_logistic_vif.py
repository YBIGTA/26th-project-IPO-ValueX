...
# ✅ (9) 종속변수를 20% 초과 여부로 변환
df_selected[target_variable] = (df_selected[target_variable] > 0).astype(int)
print("\n✅ 종속변수를 20% 초과 여부로 변환 완료!")
...
precision = precision_score(df_selected[target_variable], y_pred)
recall = recall_score(df_selected[target_variable], y_pred)
f1 = f1_score(df_selected[target_variable], y_pred)
...
print(f"  🔹 ROC AUC Score: {roc_auc:.4f}")  # ROC-AUC Score 추가
